...
def MTPSender_main(arg):
    ...
    seqNum = 0
    #start threads
    senderThread = threading.Thread(target=send_thread,args=(sendingSocket,serverAddr,serverPort,packets, seqNum,logfile))
    receiverThread = threading.Thread(target=receive_thread, args=(receiverSocket,sendingSocket,serverAddr,serverPort))
    senderThread.start()
